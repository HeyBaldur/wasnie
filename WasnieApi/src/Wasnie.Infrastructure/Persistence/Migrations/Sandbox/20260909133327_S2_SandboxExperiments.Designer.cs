...
namespace Wasnie.Infrastructure.Persistence.Migrations.Sandbox
{
    ...
    [Migration("20260909133327_S2_SandboxExperiments")]
    partial class S2_SandboxExperiments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wasnie.Domain.Assistant.AssistantConversation", b =>
                {
                    ...
                    b.ToTable("AssistantConversations", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Assistant.AssistantConversationState", b =>
                {
                    ...
                    b.ToTable("AssistantConversationStates", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.BackgroundJobs.BackgroundJobRecord", b =>
                {
                    ...
                    b.ToTable("BackgroundJobRecords", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Compensation.Assignments.PlanAssignment", b =>
                {
                    ...
                    b.ToTable("PlanAssignments", "Sandbox");
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Compensation.Enrichment.CategoryMapping", b =>
                {
                    ...
                    b.ToTable("CategoryMappings", "Sandbox");
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Compensation.Ledger.PayRunSettlement", b =>
                {
                    ...
                    b.ToTable("PayRunSettlements", "Sandbox");
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Compensation.Ledger.PayeeBalance", b =>
                {
                    ...
                    b.ToTable("PayeeBalances", "Sandbox");
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Compensation.Ledger.PayeeLedgerEntry", b =>
                {
                    ...
                    b.HasIndex("SourceTransactionId", "SourcePlanId")
                        .IsUnique()
                    ...
                    b.ToTable("PayeeLedgerEntries", "Sandbox");
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Compensation.Payouts.CompensationPayout", b =>
                {
                    ...
                    b.ToTable("CompensationPayouts", "Sandbox");
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Compensation.Payouts.PayRun", b =>
                {
                    ...
                    b.Property<int>("SupplementalSequence")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.HasIndex("TenantId", "PeriodStart", "PeriodEnd", "SupplementalSequence")
                        .IsUnique()
                        .HasDatabaseName("IX_PayRuns_Unique");

                    b.ToTable("PayRuns", "Sandbox");
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Compensation.Plans.Plan", b =>
                {
                    ...
                    b.ToTable("CompensationPlans", "Sandbox");
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Compensation.Reconciliation.ReconciliationClosure", b =>
                {
                    ...
                    b.ToTable("ReconciliationClosures", "Sandbox");
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Compensation.Transactions.CompensationTransaction", b =>
                {
                    ...
                    b.ToTable("CompensationTransactions", "Sandbox");
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.Property<string>("LegalAcceptedVersion")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<string>("SalesVolumeRange")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Wasnie.Domain.Identity.EmailChangeToken", b =>
                {
                    ...
                    b.ToTable("EmailChangeTokens", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Identity.EmailConfirmationToken", b =>
                {
                    ...
                    b.ToTable("EmailConfirmationTokens", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Integrations.Crm.CrmDriftAlert", b =>
                {
                    ...
                    b.ToTable("CrmDriftAlerts", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Integrations.Crm.CrmOwnerMapping", b =>
                {
                    ...
                    b.ToTable("CrmOwnerMappings", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("Wasnie.Domain.Integrations.Crm.DealLostAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wasnie.Domain.Integrations.HubSpot.HubSpotConnection", b =>
                {
                    ...
                    b.ToTable("HubSpotConnections", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Integrations.HubSpot.HubSpotOAuthState", b =>
                {
                    ...
                    b.ToTable("HubSpotOAuthStates", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("Wasnie.Domain.Sandbox.SandboxExperiment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wasnie.Domain.Settings.FieldRequirementSetting", b =>
                {
                    ...
                    b.ToTable("FieldRequirementSettings", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Wasnie.Domain.Subscription.ProcessedStripeEvent", b =>
                {
                    ...
                    b.ToTable("ProcessedStripeEvents", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
                    ...
                    b.OwnsOne("Wasnie.Domain.Compensation.ValueObjects.DateRange", "EffectivePeriod", b1 =>
                        {
                            ...
                            b1.ToTable("PlanAssignments", "Sandbox");
                    ...
                    b.OwnsOne("Wasnie.Domain.Compensation.ValueObjects.Money", "CarryoverRemaining", b1 =>
                        {
                            ...
                            b1.ToTable("PayRunSettlements", "Sandbox");
                    ...
                    b.OwnsOne("Wasnie.Domain.Compensation.ValueObjects.Money", "Balance", b1 =>
                        {
                            ...
                            b1.ToTable("PayeeBalances", "Sandbox");
                    ...
                    b.OwnsOne("Wasnie.Domain.Compensation.ValueObjects.Money", "Amount", b1 =>
                        {
                            ...
                            b1.ToTable("PayeeLedgerEntries", "Sandbox");
                    ...
                    b.OwnsOne("Wasnie.Domain.Compensation.ValueObjects.PayeeReference", "PayeeSnapshot", b1 =>
                        {
                            ...
                            b1.ToTable("CompensationPayouts", "Sandbox");
                    ...
                    b.OwnsOne("Wasnie.Domain.Compensation.ValueObjects.Money", "BaseAmount", b1 =>
                        {
                            ...
                            b1.ToTable("PayoutLines", "Sandbox");
                    ...
                    b.OwnsOne("Wasnie.Domain.Compensation.ValueObjects.DateRange", "EffectivePeriod", b1 =>
                        {
                            ...
                            b1.ToTable("CompensationPlans", "Sandbox");
                    ...
                    b.OwnsOne("Wasnie.Domain.Compensation.ValueObjects.Money", "Amount", b1 =>
                        {
                            ...
                            b1.ToTable("CompensationTransactions", "Sandbox");
