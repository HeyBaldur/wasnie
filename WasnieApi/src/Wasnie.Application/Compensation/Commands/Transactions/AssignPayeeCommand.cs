...
public sealed record AssignPayeeCommand(
    Guid TransactionId,
    Guid PayeeId,
    string? Comment) : IRequest<Result<TransactionDto>>, IMoneyCriticalCommand
{
    public string AuditAction => AuditActions.TransactionPayeeAssigned;
