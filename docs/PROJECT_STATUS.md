...
**Last updated:** 2026-06-03 — WI-PROD-T-FIX-10 Done. Currency whitelist added (17 ISO 4217 codes in `CurrencyConstants`; XXX/ABC/ZZZ now rejected). Plan creation also restricted to whitelist. UPDATE wizard Step 3 preview visually unified with IMPORT: 4 stat cards, functional filter tabs, category badges on issues, matched table CSS. Build clean.
