...
const ILLUSTRATIONS: Record<string, string> = {
  ...
  'transactions-empty': `
    <svg viewBox="0 0 160 120" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path d="M126 44 h12 M135 40 l3 4 -3 4" stroke="var(--color-brand)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <circle cx="28" cy="76" r="14" fill="var(--color-brand)" fill-opacity="0.06" stroke="currentColor" stroke-width="1.5"/>
    </svg>`,
  ...
  'payouts-empty': `
    <svg viewBox="0 0 160 120" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <line x1="80" y1="38" x2="80" y2="42" stroke="var(--color-brand)" stroke-width="2" stroke-linecap="round"/>
      <line x1="80" y1="74" x2="80" y2="78" stroke="var(--color-brand)" stroke-width="2" stroke-linecap="round"/>
  ...
  'quotas-empty': `
    <svg viewBox="0 0 160 120" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <line x1="80" y1="14" x2="80" y2="22" stroke="var(--color-brand)" stroke-width="1.5" stroke-linecap="round"/>
      <line x1="80" y1="98" x2="80" y2="106" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity="0.4"/>
      <line x1="34" y1="60" x2="42" y2="60" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity="0.4"/>
      <line x1="118" y1="60" x2="126" y2="60" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity="0.4"/>
    </svg>`,
...
export class EmptyStateComponent {
  ...
  readonly secondaryActionKey = input<string>('');
